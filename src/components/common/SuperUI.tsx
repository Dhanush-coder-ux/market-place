...
export function TypeBadge({ type, labelOverride, icon: Icon }: { type: string, labelOverride?: string, icon?: any }) {
  ...
  else if (t.includes("SALES_RETURN") || t.includes("SALES RETURN") || t.includes("SALE_RETURN") || t.includes("SALE RETURN") || t.includes("OFFLINE_SALES_RETURN") || t.includes("OFFLINE SALES RETURN")) { variant = "tx-sales-return"; label = "Sales Return"; }
  else if (t.includes("ONLINE_SALES_EXCHANGE") || t.includes("ONLINE SALES EXCHANGE")) { variant = "tx-sales"; label = "Online Sales Exchange"; }
  else if (t.includes("OFFLINE_SALES_EXCHANGE") || t.includes("OFFLINE SALES EXCHANGE") || t.includes("SALES_EXCHANGE") || t.includes("SALES EXCHANGE")) { variant = "tx-sales"; label = "Sales Exchange"; }
  else if (t.includes("ONLINE_EXCHANGE") || t.includes("ONLINE EXCHANGE")) { variant = "tx-sales"; label = "Online Exchange"; }
  else if (t.includes("OFFLINE_EXCHANGE") || t.includes("OFFLINE EXCHANGE") || t.includes("EXCHANGE")) { variant = "tx-sales"; label = "Exchange"; }
