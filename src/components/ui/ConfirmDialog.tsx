          ...
          >
            <div className="p-8 space-y-6">
              ...
              <div className="flex items-center gap-3 pt-2">
                <button
                  onClick={onClose}
                  className="flex-1 h-12 rounded-2xl border border-slate-200 text-slate-600 font-bold hover:bg-slate-50 transition-all active:scale-95"
                >
                  {cancelText}
                </button>
                <button
                  ...
                  className={`flex-1 h-12 rounded-2xl text-white font-bold transition-all shadow-lg active:scale-95 ${
                    variant === "danger" 
