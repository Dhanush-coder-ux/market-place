      ...
      <div className="flex items-center gap-3 animate-in fade-in slide-in-from-right-4 duration-300">
        {!id && (
          <button
            ...
            className="px-4 h-10 rounded-xl border border-blue-100 text-blue-600 font-semibold text-xs bg-blue-50/50 hover:bg-blue-100 transition-all flex items-center gap-2"
          >
            <Bookmark size={14} /> Save Draft
          </button>
        )}
        <GradientButton
          icon={submitting ? <Loader className="h-4 w-4" /> : <Save size={15} />}
              ...
              <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <ReusableSelect
                    ...
                    onValueChange={(val) => setGrnDetails(d => ({ ...d, status: val as GRNStatus }))}
